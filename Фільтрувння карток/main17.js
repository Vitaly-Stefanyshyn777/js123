...
// const sbtnCloseButton = document.querySelector(".close");
...
// class AddCard {
// addCard(index){
//     const { imagePath, model, description, reviews, price,
//     discount }
//       = phones[index];
//     return`
//             <div class="card">
...
//                   <div class="card__m-text">Цена</div>
//                   <div class="card__m-money">${price}</div>
//                 </div>
//                 <div class="card__m-left">
//                   <div class="card__m-text">Со скидкой</div>
//                   <div class="card__m-money">
//                     <mark>${price - discount}</mark>
//                     <span>${discount}</span>
//                   </div>
//                 </div>
//               </div>
//               <img class="img-svg" src="img/0012.svg" alt="" />
//               <img class="img-b5" src="img/b5.svg" alt="" />
//             </div>;
//     `
// }
// }
...
//     showButton.classList.toggle("bn")
//     sbtnCloseButton.classList.toggle("bn")
...
// sbtnCloseButton.addEventListener("click", () => {
//     showButton.classList.toggle("bn")
//     sbtnCloseButton.classList.toggle("bn")
//     cardsContainer.innerHTML = ""
// });
...
//         phone.model.toLocaleLowerCase().startsWith(inputValue.
//             toLowerCase())
//     );
...
const phones = [
  // Масив об'єктів, де кожен об'єкт представляє телефон з відповідними властивостями: модель, ціна, опис, знижка, шлях до зображення та кількість відгуків.
  {
    model: "iPhone 13",
    price: 1000,
    description: "iPhone 13 - это новая модель телефона от Apple с передовыми технологиями и функциями.",
    discount: 100,
    imagePath: "img/iphone13.jpg",
    reviews: 138
  },
  {
    model: "Samsung Galaxy S21",
    price: 1200,
    description: "Samsung Galaxy S21 - это новый флагманский смартфон от Samsung с потрясающим экраном и мощным процессором.",
    discount: 80,
    imagePath: "img/SamsungGalaxyS21.jpg",
    reviews: 2367
  },
  {
    model: "Google Pixel 6",
    price: 800,
    description: "Google Pixel 6 - это последняя модель телефона от Google с отличной камерой и инновационными функциями.",
    discount: 50,
    imagePath: "img/GooglePixel6.jpg",
    reviews: 876
  },
  // Додаткові об'єкти для інших моделей телефонів.
];
  ...
  addCard(index) {
    ...
    return `
      <div class="card">
        ...
        <div class="card__rating">
          <div class="rating__span">
            <span>${"&#9733;".repeat(5)}</span> <!-- Символи зірок для рейтингу -->
          </div>
        ...
        <div class="card__m">
          ...
          <div class="card__m-left">
            ...
            <div class="card__m-money">
              <mark>${price - discount}$</mark><span>${discount}$</span> <!-- Ціна зі знижкою -->
            </div>
          </div>
        </div>
